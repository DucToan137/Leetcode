<h2><a href="https://leetcode.com/problems/find-if-digit-game-can-be-won/description/">Find if Digit Game Can Be Won
</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr>


<div class="elfjS" data-track-load="description_content"><p>You are given an array of <strong>positive</strong> integers <code>nums</code>.</p>
